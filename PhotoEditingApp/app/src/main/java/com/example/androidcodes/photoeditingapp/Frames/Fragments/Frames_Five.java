...
/**
 * Created by peacock on 22/4/16.
 */
public class Frames_Five extends Fragment implements View.OnClickListener, View.OnLongClickListener,
        View.OnDragListener {
    ...
    private TouchImageView tiv_image_1, tiv_image_2, tiv_image_3, tiv_image_4,
            tiv_image_5;

    private LinearLayout ll_editLayout1, ll_editLayout2, ll_editLayout3, ll_editLayout4,
            ll_editLayout5;

    private TextView tv_effect1, tv_effect2, tv_effect3, tv_effect4, tv_effect5,
            tv_changeImg1, tv_changeImg2, tv_changeImg3, tv_changeImg4, tv_changeImg5;
    ...
    private BroadcastReceiver recieve_visibility_broadcast = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getStringExtra("Visibility").equals("gone")) {
                ...
                ll_editLayout4.setVisibility(View.GONE);

                ll_editLayout5.setVisibility(View.GONE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (Common.frame_number == 0) {
            ...
            view = inflater.inflate(R.layout.frame_50, null);

        } else if (Common.frame_number == 1) {

            view = inflater.inflate(R.layout.frame_51, null);

        } else if (Common.frame_number == 2) {

            view = inflater.inflate(R.layout.frame_52, null);

        } else if (Common.frame_number == 3) {

            view = inflater.inflate(R.layout.frame_53, null);

        } else if (Common.frame_number == 4) {

            view = inflater.inflate(R.layout.frame_54, null);

        } else if (Common.frame_number == 5) {

            view = inflater.inflate(R.layout.frame_55, null);

        } else if (Common.frame_number == 6) {

            view = inflater.inflate(R.layout.frame_56, null);

        } else if (Common.frame_number == 7) {

            view = inflater.inflate(R.layout.frame_57, null);

        } else if (Common.frame_number == 8) {

            view = inflater.inflate(R.layout.frame_58, null);

        } else if (Common.frame_number == 9) {

            view = inflater.inflate(R.layout.frame_59, null);
        ...
        tiv_image_1.setMinZoom(0.5f);
        tiv_image_1.setMaxZoom(7.0f);
        ...
        tiv_image_2.setMinZoom(0.5f);
        tiv_image_2.setMaxZoom(7.0f);
        ...
        tiv_image_3.setMinZoom(0.5f);
        tiv_image_3.setMaxZoom(7.0f);
        ...
        tiv_image_4 = (TouchImageView) view.findViewById(R.id.tiv_image_4);
        tiv_image_4.setMinZoom(0.5f);
        tiv_image_4.setMaxZoom(7.0f);
        tiv_image_4.setOnClickListener(this);
        tiv_image_4.setOnLongClickListener(this);
        tiv_image_4.setOnDragListener(this);
        tiv_image_4.setTag(3);
        tiv_image_4.setDrawingCacheEnabled(true);

        tiv_image_5 = (TouchImageView) view.findViewById(R.id.tiv_image_5);
        tiv_image_5.setMinZoom(0.5f);
        tiv_image_5.setMaxZoom(7.0f);
        tiv_image_5.setOnClickListener(this);
        tiv_image_5.setOnLongClickListener(this);
        tiv_image_5.setOnDragListener(this);
        tiv_image_5.setTag(4);
        tiv_image_5.setDrawingCacheEnabled(true);
        ...
        ll_editLayout4 = (LinearLayout) view.findViewById(R.id.ll_editLayout4);

        ll_editLayout5 = (LinearLayout) view.findViewById(R.id.ll_editLayout5);
        ...
        tv_effect4 = (TextView) view.findViewById(R.id.tv_effect4);
        tv_effect4.setOnClickListener(this);

        tv_effect5 = (TextView) view.findViewById(R.id.tv_effect5);
        tv_effect5.setOnClickListener(this);
        ...
        tv_changeImg4 = (TextView) view.findViewById(R.id.tv_changeImg4);
        tv_changeImg4.setOnClickListener(this);

        tv_changeImg5 = (TextView) view.findViewById(R.id.tv_changeImg5);
        tv_changeImg5.setOnClickListener(this);
        ...
        Common.iv_frame_4 = (ImageView) view.findViewById(R.id.iv_frame_4);
        Common.iv_frame_3.setColorFilter(ContextCompat.getColor(activity,
                R.color.cardview_light_background), PorterDuff.Mode.MULTIPLY);

        Common.iv_frame_5 = (ImageView) view.findViewById(R.id.iv_frame_5);
        Common.iv_frame_5.setColorFilter(ContextCompat.getColor(activity,
                R.color.cardview_light_background), PorterDuff.Mode.MULTIPLY);
        ...
        tiv_image_4.setImageBitmap(Common.selected_bitmaps.get(3));

        tiv_image_5.setImageBitmap(Common.selected_bitmaps.get(4));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tiv_image_4:

                if (ll_editLayout4.getVisibility() == View.GONE) {

                    tv_effect4.setAnimation(AnimationUtils.loadAnimation(activity,
                            android.R.anim.fade_in));

                    tv_changeImg4.setAnimation(AnimationUtils.loadAnimation(activity,
                            android.R.anim.fade_in));

                    ll_editLayout4.setVisibility(View.VISIBLE);
            ...
            case R.id.tiv_image_5:

                if (ll_editLayout5.getVisibility() == View.GONE) {

                    tv_effect5.setAnimation(AnimationUtils.loadAnimation(activity,
                            android.R.anim.fade_in));

                    tv_changeImg5.setAnimation(AnimationUtils.loadAnimation(activity,
                            android.R.anim.fade_in));

                    ll_editLayout5.setVisibility(View.VISIBLE);
            ...
            case R.id.tv_effect4:

                Common.applyEffect(3, activity);

                /*PIP_Common.selected_image_number = 3;

                PIP_Common.edit_selected_framed_image = PIP_Common.selected_bitmaps.get(3);
            ...
            case R.id.tv_effect5:

                Common.applyEffect(4, activity);

                /*PIP_Common.selected_image_number = 4;

                PIP_Common.edit_selected_framed_image = PIP_Common.selected_bitmaps.get(4);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_IMAGE && resultCode == activity.RESULT_OK && data != null) {
            ...
            if (bmp != null) {
                ...
                } else if (Common.selected_image_number == 3) {

                    tiv_image_4.setImageBitmap(Common.selected_bitmaps.get(3));

                } else if (Common.selected_image_number == 4) {
    ...
    public void onResume() {
        ...
        //Common.getSetZoom(false, tiv_image_1, tiv_image_2, tiv_image_3, tiv_image_4, tiv_image_5);
    ...
    public void onPause() {
        ...
        //Common.getSetZoom(true, tiv_image_1, tiv_image_2, tiv_image_3, tiv_image_4, tiv_image_5);
