...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
    ...
    /** btn text(按钮内容) */
    protected String mBtnLeftText = "OK";
    protected String mBtnRightText = "Cancel";
    protected String mBtnMiddleText = "OK";
    ...
    public void setUiBeforShow() {
        ...
        mTvTitle.setText(TextUtils.isEmpty(mTitle) ? "PIP Effect" : mTitle);
        mTvTitle.setTextColor(mTitleTextColor);
        mTvTitle.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTitleTextSize);
        mTvTitle.setPadding(2,20,2,0);
