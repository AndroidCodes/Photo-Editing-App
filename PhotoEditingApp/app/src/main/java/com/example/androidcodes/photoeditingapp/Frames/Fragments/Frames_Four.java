...
/**
 * Created by peacock on 21/4/16.
 */
public class Frames_Four extends Fragment implements View.OnClickListener, View.OnLongClickListener,
        View.OnDragListener {
    ...
    private TextView tv_effect1, tv_effect2, tv_effect3, tv_effect4, tv_changeImg1,
            tv_changeImg2, tv_changeImg3, tv_changeImg4;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (Common.frame_number == 0) {
            ...
            view = inflater.inflate(R.layout.frame_40, null);

        } else if (Common.frame_number == 1) {

            view = inflater.inflate(R.layout.frame_41, null);

        } else if (Common.frame_number == 2) {

            view = inflater.inflate(R.layout.frame_42, null);

        } else if (Common.frame_number == 3) {

            view = inflater.inflate(R.layout.frame_43, null);

        } else if (Common.frame_number == 4) {

            view = inflater.inflate(R.layout.frame_44, null);

        } else if (Common.frame_number == 5) {

            view = inflater.inflate(R.layout.frame_45, null);

        } else if (Common.frame_number == 6) {

            view = inflater.inflate(R.layout.frame_46, null);

        } else if (Common.frame_number == 7) {

            view = inflater.inflate(R.layout.frame_47, null);

        } else if (Common.frame_number == 8) {

            view = inflater.inflate(R.layout.frame_48, null);

        } else if (Common.frame_number == 9) {

            view = inflater.inflate(R.layout.frame_49, null);
    ...
    public void onResume() {
       ...
       //Common.getSetZoom(false, tiv_image_1, tiv_image_2, tiv_image_3, tiv_image_4, null);
    ...
    public void onPause() {
        ...
        //Common.getSetZoom(true, tiv_image_1, tiv_image_2, tiv_image_3, tiv_image_4, null);
